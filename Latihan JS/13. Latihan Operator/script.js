let aritmatikaAngka1,
  operatorAritmatika,
  aritmatikaAngka2,
  hasilOperatorAritmatika;
...
document.getElementById("buttonAritmatika").onclick = function () {
  ...
  // operasi
  hasilOperatorAritmatika = eval(
    aritmatikaAngka1 + operatorAritmatika + aritmatikaAngka2
  );

  // output
  document.getElementById("hasilOperatorAritmatika").textContent =
    hasilOperatorAritmatika;
};
...
document.getElementById("buttonLogika").onclick = function () {
  ...
  // output
  document.getElementById("hasilOperatorLogika").textContent =
    hasilOperatorLogika;
};
